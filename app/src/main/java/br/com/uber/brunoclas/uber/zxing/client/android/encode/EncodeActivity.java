...
import br.com.uber.brunoclas.uber.zxing.client.android.FinishListener;
...
//  @Override
//  public boolean onCreateOptionsMenu(Menu capture) {
//    MenuInflater menuInflater = getMenuInflater();
//    menuInflater.inflate(R.capture.encode, capture);
...
//    MenuItem encodeItem = capture.findItem(R.id.menu_encode);
...
//    }
//    return super.onCreateOptionsMenu(capture);
//  }
//
//  @Override
  ...
  protected void onResume() {
    ...
    try {
      ...
      if (intent.getBooleanExtra(Intents.Encode.SHOW_CONTENTS, true)) {
        contents.setText("R$: " + qrCodeEncoder.getDisplayContents());
