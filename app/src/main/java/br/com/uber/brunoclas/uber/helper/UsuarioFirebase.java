package br.com.uber.brunoclas.uber.helper;
...
import br.com.uber.brunoclas.uber.activity.RequisicoesActivity;
...
public class UsuarioFirebase {
    ...
    public static String getIdentificadorUuario(){
