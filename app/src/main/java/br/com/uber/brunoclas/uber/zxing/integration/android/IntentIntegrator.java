...
package br.com.uber.brunoclas.uber.zxing.integration.android;
...
public class IntentIntegrator {
  ...
  private static final String BS_PACKAGE = "br.com.uber.brunoclas.uber.zxing.client.android";
   ...
   *
   * @param text the text string to encode as a barcode
   * @param type type of data to encode. See {@code br.com.uber.brunoclas.uber.zxing.client.android.Contents.Type} constants.
   * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
   *   if a prompt was needed, or null otherwise
   */
